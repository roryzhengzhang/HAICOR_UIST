    ...
    return (
        <>
			...
			<div style={{display: "flex", "justify-content": "space-between"}}>
	        	...
	        	<div class="chatbot" style={{height: "100%", display: "block", margin: "0 auto", width: "75%"}}>
		            <Head>
		        ...
		        <div class="visualization" style={{float: "right", "borderStyle": "solid", width: "20%"}}>Visual</div>
		    </div>
        </>
    );
}
